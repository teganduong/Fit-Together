...
// run this to add schema tables to rds db instance
// psql --host=fidgetywidget.c67fs1cxhe7n.us-west-2.rds.amazonaws.com --port=5432 --username=fidgetywidget --password --dbname=fidgetywidget < src/server/db/schema.sql

// run this to log into amazon rds db instance
